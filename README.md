...
**Documentation (German)**  | https://docs.goobi.io/de/workflow/plugins/export/goobi-plugin-export-fedora
**Documentation (English)** | https://docs.goobi.io/en/workflow/plugins/export/goobi-plugin-export-fedora
